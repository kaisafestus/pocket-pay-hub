...
DROP TRIGGER IF EXISTS transactions_create_messages ON public.transactions;
CREATE TRIGGER transactions_create_messages
AFTER INSERT ON public.transactions
FOR EACH ROW
EXECUTE FUNCTION public.create_txn_messages();